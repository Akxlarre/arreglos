...
if(empty($_SESSION["cloux_new"])){
  ...
  $newTicket = isset($_SESSION["permisos_new"]) && $_SESSION["permisos_new"][124] ? 1 : 0;
  $deleteTicket = isset($_SESSION["permisos_new"]) && $_SESSION["permisos_new"][125] ? 1 : 0;
...
while ($row = mysqli_fetch_array($rs)) {
    if ($row[0] != '' && $row[0] != null) {
        ...
        if (trim($row[0]) != 'mysql' && trim($row[0]) != 'information_schema' && trim($row[0]) != 'performance_schema') {
            $empresas[] = $row[0];
			if ($indim2 == 0) {
				$optionsclientesform .= '<option value="GENERAL">GENERAL</option>';
			}
                ...
                <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9 pt-2">
                                    <select name="tck_asig" id="tck_asig" class="form-control form-control-sm" data-placeholder="Seleccione" 
                                    <?php //if ($data["usu_nombre"] !== "Jaime" && $data["usu_nombre"] !== "John") echo 'disabled'; ?>
                                    <?php if ( !in_array($data["usu_nombre"], array("Jaime", "John", "nitzi", "Laura") )) echo 'disabled'; ?>>
                                    <?php echo $optionsUsr?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9 pt-2">
                                    <select name="tck_asig_cli" id="tck_asig_cli" class="form-control form-control-sm" data-placeholder="Seleccione" 
                                    <?php if ( !in_array($data["usu_nombre"], array("Jaime", "John", "nitzi", "Laura") )) echo 'disabled'; ?>>
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-9 pt-2" >
                                    <input type="file" class="inputfile form-control form-control-sm" multiple id="fileImg" name="files">
                                </div>
                            </div> 
...
<script>
    ...
    var deleteTicket = <?php echo isset($_SESSION["permisos_new"]) && $_SESSION["permisos_new"][125] ? 1 : 0; ?>;
