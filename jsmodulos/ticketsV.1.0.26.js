      ...
      if(ticket.length > 0){
        ...
        if(ticket[0].Imagenes.length > 0){
            $.each(ticket[0].Imagenes, function(i, items) {
                $("#preview").html('<li><a href="../admin/dist/img/tickets/'+Imagenes.NombreImg+' download"</a></li>');
...
function listarComentarios(id) {
    ...
    $.ajax({
        ...
        beforeSend: function(respuesta) {
            ...
            // Utilizamos un bucle for...of para recorrer los datos
            ...
            // Finalmente, actualizamos el contenido de los divs con el id "divCom" y "divComDos"
           // $('#msCliente').html(filaCli);
            //$('#msSop ').html(filaSop);
