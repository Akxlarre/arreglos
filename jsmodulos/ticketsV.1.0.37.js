...
function listarTiempos(id) {
    ...
    $.ajax({
        ...
        beforeSend: function(respuesta) {
            ...
            ticketsTiempos = data;
            $.each(data, function(i, items) {
                $('#sop_eje').html(ticketsTiempos.Tiempo_sop_tomado);
                $('#eje_vali').html(ticketsTiempos.Tiempo_ejecu_envio);
                $('#vali_confi').html(ticketsTiempos.Tiempo_envio_confirmo);
                $('#sop_confi').html(ticketsTiempos.Tiempo_soporte_confirmo);
            })
        }
    });
}
